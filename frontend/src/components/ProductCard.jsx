    ...
    <div className="group bg-white rounded-2xl overflow-hidden shadow-card hover:shadow-soft transition-all duration-300 border border-rose-50">
      ...
      <div className="p-4">
        ...
        <div className="mt-3 flex gap-2">
          ...
          <a
            href={whatsappOrderUrl(product.name, product.price, product.nbfCode, {})}
            target="_blank"
            rel="noopener noreferrer"
            className="hidden sm:inline-flex items-center justify-center bg-green-500 text-white px-3 py-2.5 rounded-xl font-medium hover:bg-green-600 transition disabled:opacity-50"
            disabled={!product.inStock}
          >
            <WhatsAppIcon />
          </a>
